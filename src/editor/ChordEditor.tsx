...
export default function ChordEditor() {
  ...
  // Auto‐save/Load da localStorage
  useEffect(() => {
    ...
    <div style={{ display:"flex", height:"100vh", background:"#1e1e1e", color:"#ddd" }}>
      <aside style={{ width:240, padding:16, background:"#2b2b2b" }}>
        ...
        <div style={{ marginBottom:16 }}>
          <label style={{ color:"#ccc", display:"block", marginBottom:4 }}>
            Titolo:
          </label>
          <input
            type="text"
        ...
        <button onClick={exportPrint} style={btnStyle}>
          <FaPrint /> Stampa
        </button>
        ...
        {placed.map((c,i)=>((
          <div
            ...
            style={{
              ...
              borderRadius:4,
              cursor: movingIndex===i ? "move" : "pointer",
              userSelect:"none"
            }}
          >
            {c.chord}
